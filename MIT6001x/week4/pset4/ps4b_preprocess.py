...
def wordPointDict(wordList):
    """
    calculate scores for each word and create a dict(word -> score)
    
    wordList: list (string)
    returns: dictionary (string -> int), else None
    """    
    wordDict = {}
...
def compChooseWord(hand, wordDict, n):
    ...
    If no words in the wordDictt can be made from the hand, return None.
...
if __name__ == '__main__':
    wordList = loadWords()
    wordDict = wordPointDict(wordList)
