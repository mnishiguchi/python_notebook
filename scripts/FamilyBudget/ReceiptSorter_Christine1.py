################################################################################
##  ReceiptSorter_Christine.py                
##    Author: Masatoshi Nishiguchi    July 7, 2014       
##    * Click on green triangle to run the program           
##    * If the program freezes, press [Ctrl] + [.] to restart
################################################################################
    ...
    while True:
        ...
        while True: 
            ...
            if code.isdigit() and int(code) >= 0 and int(code) < len(CATEGORIES):
                ...
                print ">>> Oops!  That was no valid number.  Please reference CATEGORY CODES" 
        ...
        if wantResult == 'r' or wantResult == 'R':
            ...
            while True:
                ...
                if closure == 'S' or closure == 's':
                    ...
                    # successful
                    print
                    print ">>> Your data is successfully saved as \"" + fileName + "\" at", PATH
                    return
